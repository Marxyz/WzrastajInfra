...
namespace WzrastajAuth
{
    ...
    public class AuthActionHandler : IAuthActionHandler
    {
        ...
        public AuthActionHandler(IJwtTokenValidator jwtTokenValidator, IJwtFactory jwtFactory,
        ...
        public async Task ProcessForgetPasswordRequestAsync(string mail)
        {
            ...
            //await MailService.SendRegistrationAsync(resetToken.Value, user.AuthorInfo.Mail, user.AuthorInfo.Name, user.Id.ToString());
        }
